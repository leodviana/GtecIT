...
namespace GtecIt.Controllers
{
    public class RelatorioController : Controller
    {
        ...
        public ActionResult RelAtendimentoPeriodo(RelGeralViewlModel model)
        {
            ...
            {
                //viewer.SetParameters(new ReportParameter("cliente", "TODOS OS CLIENTES"));
                rd.DataDefinition.FormulaFields["Ordem"].Text = "'TODOS OS CONVÊNIOS'";
            }
            else
            {
                var convenio = _uoW.Convenios.ObterPorId(model.ConvenioId);

                rd.DataDefinition.FormulaFields["Ordem"].Text = "'" + convenio.grlbasic.nome + "'";
            }
            rd.SetDataSource(ds);
            //rd.SetDataSource(ds.Tables[1]);
            ...
            string filePath = Server.MapPath("~/temp/Rel002 - Titulos a Receber por periodo.pdf");
        ...
        public ActionResult RelAtendimentoPeriodosemtitulos(RelGeralViewlModel model, string acao)
        {
            ...
            model.ConvenioDropDown =
               _uoW.Convenios.ObterTodos().Where(x => x.Ativo.Equals("S") && x.Guia == "N")
                    .OrderBy(x => x.grlbasic.nome)
                    .Select(x => new SelectListItem { Text = x.grlbasic.nome, Value = x.id_grlconvenio.ToString() })
                    .ToList();
        ...
        public ActionResult RelAtendimentoPeriodosemtitulos(RelGeralViewlModel model)
        {
            ...
            string filePath = Server.MapPath("~/temp/Rel006 - Atendimentos sem titulos a receber por periodo.pdf");
        ...
        public ActionResult RelAtendimentoPeriodocancelado(RelGeralViewlModel model)
        {
            ...
            string filePath = Server.MapPath("~/temp/Rel005 - Atendimentos Cancelados por periodo.pdf");
        ...
        public ActionResult Relatendimentopordentista(RelGeralViewlModel model)
        {
            ...
            {
                //viewer.SetParameters(new ReportParameter("cliente", "TODOS OS CLIENTES"));
                rd.DataDefinition.FormulaFields["Ordem"].Text = "'TODOS OS DENTISTAS'";
            }
            else
            {
            ...
            string filePath = Server.MapPath("~/temp/Rel007 - Atendimentos por Dentista.pdf");
        ...
        public ActionResult Relatendimentopordentistasintetico(RelGeralViewlModel model)
        {
            ...
            string filePath = Server.MapPath("~/temp/Rel008 - Atendimentos por Dentista sintetico.pdf");
        ...
        public ActionResult RelExamespordentista(RelGeralViewlModel model)
        {
            ...
            string filePath = Server.MapPath("~/temp/Rel009 - Exames por Dentista.pdf");
        ...
        public ActionResult RelAtendimentoPeriodoporconnvenio(RelGeralViewlModel model)
        {
            ...
            string filePath = Server.MapPath("~/temp/Rel003 - Atendimentos por periodo Sintético.pdf");
